...
const markdown = `**Website Terms of Us**

**Version 1.0**

**Last revised on: 22 November 2023**

The website located at https://codelynx.dev (the "**Site**") is a
copyrighted work belonging to Codelynx, LLC ("**Company**", "**us**",
...
AND JURY TRIAL WAIVER. PLEASE READ SECTION 10.2 CAREFULLY.**
...
1.  Accounts**
    ...
    1.  **Account Creation.** In order to use certain features of the
        > Site, you must register for an account ("**Account**") and
    ...
    2.  **Account Responsibilities.** You are responsible for
...
2.  Access to the Site**
    ...
    3.  **Modification.** Company reserves the right, at any time, to
    ...
    4.  **No Support or Maintenance.** You acknowledge and agree that
        > Company will have no obligation to provide you with any
        > support or maintenance in connection with the Site.

    5.  **Ownership.** Excluding any User Content that you may provide
    ...
    6.  **Feedback.** If you provide Company with any feedback or
...
3.  **User Content**
    ...
    1.  **User Content.** "**User Content**" means any and all
        > information and content that a user submits to, or uses with,
        > the Site (e.g., content in the user's profile or postings).
        > You are solely responsible for your User Content. You assume
        > all risks associated with use of your User Content, including
        > any reliance on its accuracy, completeness or usefulness by
        ...
        > sponsored or endorsed by Company. Since you alone are
    ...
    2.  **License.** You hereby grant (and you represent and warrant
        > that you have the right to grant) to Company an irrevocable,
    ...
    3.  **Acceptable Use Policy.** The following terms constitute our
        ...
        b.  In addition, you agree not to: (i) upload, transmit, or
            ...
            > Site), whether through password mining or any other
            > means; (vi) harass or interfere with any other user's use
            > and enjoyment of the Site; or (vi) use software or
            > automated agents or scripts to produce multiple accounts
    ...
    4.  **Enforcement.** We reserve the right (but have no obligation)
        > to review, refuse and/or remove any User Content in our sole
        > discretion, and to investigate and/or take appropriate action
        > against you in our sole discretion if you violate the
...
4.  **Indemnification.** You agree to indemnify and hold
    ...
    Site, (b) your violation of these Terms, (c) your violation of
...
5.  **Third-Party Links & Ads; Other Users**
    ...
    1.  **Third-Party Links & Ads.** The Site may contain links to
        > third-party websites and services, and/or display
        > advertisements for third parties (collectively, "**Third-Party
        > Links & Ads**"). Such Third-Party Links & Ads are not under
        > the control of Company, and Company is not responsible for any
        ...
        > applicable third party's terms and policies apply, including
        > the third party's privacy and data gathering practices. You
    ...
    2.  **Other Users.** Each Site user is solely responsible for any
        > and all of its own User Content. Since we do not control User
        > Content, you acknowledge and agree that we are not responsible
        > for any User Content, whether provided by you or by others. We
        > make no guarantees regarding the accuracy, currency,
        > suitability, appropriateness, or quality of any User Content.
    ...
    3.  **Release.** You hereby release and forever discharge Company
...
1.  **Term and Termination.** Subject to this Section,
...
1.  **General**
    ...
    1.  **Changes.** These Terms are subject to occasional revision, and
        > if we make any substantial changes, we may notify you by
        > sending you an e-mail to the last e-mail address you provided
        > to us (if any), and/or by prominently posting notice of the
        > changes on our Site. You are responsible for providing us with
        > your most current e-mail address. In the event that the last
        > e-mail address that you have provided us is not valid, or for
        > any reason is not capable of delivering to you the notice
    ...
    2.  **Dispute Resolution** Please read the following
        ...
        > Agreement**") carefully.  It requires you to arbitrate
        > disputes with Company, its parent companies, subsidiaries,
        ...
        > manner in which you can seek relief from the Company
        > Parties*.* 

        a.  **Applicability of Arbitration Agreement**
            > You agree that any dispute between you and any of the
            > Company Parties relating in any way to the Site, the
            > services offered on the Site (the "**Services**") or these
            > Terms will be resolved by binding arbitration, rather than
            > in court, except that (1) you and the Company Parties may
            ...
            > Parties may seek equitable relief in court for
            > infringement or other misuse of intellectual property
            > rights (such as trademarks, trade dress, domain names,
            > trade secrets, copyrights, and patents). **This
            > Arbitration Agreement shall survive the expiration or
            > termination of these Terms and shall apply, without
            > limitation, to all claims that arose or were asserted
            > before you agreed to these Terms (in accordance with the
            > preamble) or any prior version of these Terms.** This
            ...
            > relief against the Company Parties on your behalf. For
            > purposes of this Arbitration Agreement, "**Dispute**" will
            > also include disputes that arose or involve facts
            > occurring before the existence of this or any prior
            > versions of the Agreement as well as claims that may arise
            > after the termination of these Terms.

        b.  **Informal Dispute Resolution.** There might be instances
            > when a Dispute arises between you and Company. If that
            > occurs, Company is committed to working with you to reach
            > a reasonable resolution. You and Company agree that good
            ...
            > small claims court if a party so elects), we will
            > personally meet and confer telephonically or via
            > videoconference, in a good faith effort to resolve
            > informally any Dispute covered by this Arbitration
            > Agreement ("**Informal Dispute Resolution Conference**").
            > If you are represented by counsel, your counsel may
            > participate in the conference, but you will also
...
contact@codelynx.dev, or by regular mail to 2810 N Church St, PMB 85044,
Wilmington, DE 19802 US, Wilmington, Delaware 19802. The Notice must
...
1.  1.  a.  **Arbitration Rules and Forum.** These Terms
            > evidence a transaction involving interstate commerce; and
            > notwithstanding any other provision herein with respect to
            > the applicable substantive law, the Federal Arbitration
            > Act, 9 U.S.C. § 1 et seq., will govern the interpretation
            > and enforcement of this Arbitration Agreement and any
            > arbitration proceedings. If the Informal Dispute
            > Resolution Process described above does not resolve
            > satisfactorily within 60 days after receipt of your
            > Notice, you and Company agree that either party shall have
            > the right to finally resolve the Dispute through binding
            > arbitration. The Federal Arbitration Act governs the
            ...
            > Disputes involving claims and counterclaims with an amount
            > in controversy under \$250,000, not inclusive of
            > attorneys' fees and interest, shall be subject to JAMS'
            ...
            > at [www.jamsadr.com](http://www.jamsadr.com/) or by
            > calling JAMS at 800-352-5267. A party who wishes to
            > initiate arbitration must provide the other party with a
            > request for arbitration (the "**Request**"). The Request
            > must include: (1) the name, telephone number, mailing
            > address, e‐mail address of the party seeking arbitration
            > and the account username (if applicable) as well as the
            > email address associated with any applicable account; (2)
            > a statement of the legal claims being asserted and the
            > factual bases of those claims; (3) a description of the
            > remedy sought and an accurate, good‐faith calculation of
            > the amount in controversy in United States Dollars; (4) a
            > statement certifying completion of the Informal Dispute
            > Resolution process as described above; and (5) evidence
            > that the requesting party has paid any necessary filing
...
1.  1.  a.  **Authority of Arbitrator** The arbitrator
            > shall have exclusive authority to resolve all disputes
            > subject to arbitration hereunder including, without
            ...
            > Relief" is unenforceable, illegal, void or voidable, or
            > that such subsection entitled "Waiver of Class or Other
            ...
            > subsection entitled "Batch Arbitration," all Disputes
            > about the payment of arbitration fees shall be decided
            > only by a court of competent jurisdiction and not by an
            > arbitrator; (3) all Disputes about whether either party
            > has satisfied any condition precedent to arbitration shall
            > be decided only by a court of competent jurisdiction and
            > not by an arbitrator; and (4) all Disputes about which
            > version of the Arbitration Agreement applies shall be
            > decided only by a court of competent jurisdiction and not
            > by an arbitrator. The arbitration proceeding will not be
            > consolidated with any other matters or joined with any
            > other cases or parties, except as expressly provided in
            > the subsection entitled "Batch Arbitration." The
            ...
            > Arbitration Agreement). The arbitrator shall issue a
            ...
            > calculation of any damages awarded. The arbitrator shall
            > follow the applicable law. The award of the arbitrator is
            > final and binding upon you and us. Judgment on the
            > arbitration award may be entered in any court having
            > jurisdiction.

        b.  **Waiver of Jury Trial. EXCEPT AS SPECIFIED
            > in section 10.2(a) YOU AND THE COMPANY PARTIES HEREBY
            > WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO SUE IN
            > COURT AND HAVE A TRIAL IN FRONT OF A JUDGE OR A JURY. You
            > and the Company Parties are instead electing that all
            > covered claims and disputes shall be resolved exclusively
            > by arbitration under this Arbitration Agreement, except as
            > specified in Section 10.2(a) above. An arbitrator can
            > award on an individual basis the same damages and relief
            > as a court and must follow these Terms as a court would.
            > However, there is no judge or jury in arbitration, and
            > court review of an arbitration award is subject to very
            > limited review. 

        c.  **Waiver of Class or Other Non-Individualized**
            > Relief. YOU AND COMPANY AGREE THAT, EXCEPT
            > AS SPECIFIED IN SUBSECTION 10.2(h) EACH OF US MAY BRING
            > CLAIMS AGAINST THE OTHER ONLY ON AN INDIVIDUAL BASIS AND
            > NOT ON A CLASS, REPRESENTATIVE, OR COLLECTIVE BASIS, AND
            > THE PARTIES HEREBY WAIVE ALL RIGHTS TO HAVE ANY DISPUTE BE
            > BROUGHT, HEARD, ADMINISTERED, RESOLVED, OR ARBITRATED ON A
            > CLASS, COLLECTIVE, REPRESENTATIVE, OR MASS ACTION BASIS.
            > ONLY INDIVIDUAL RELIEF IS AVAILABLE, AND DISPUTES OF MORE
            ...
            > individual claim. Nothing in this paragraph is intended
            > to, nor shall it, affect the terms and conditions under
            > the Subsection 10.2(h) entitled "Batch Arbitration."
            > Notwithstanding anything to the contrary in this
            > Arbitration Agreement, if a court decides by means of a
            > final decision, not subject to any further appeal or
            > recourse, that the limitations of this subsection, "Waiver
            > of Class or Other Non-Individualized Relief," are invalid
            > or unenforceable as to a particular claim or request for
            > relief (such as a request for public injunctive relief),
            > you and Company agree that that particular claim or
            > request for relief (and only that particular claim or
            > request for relief) shall be severed from the arbitration
            > and may be litigated in the state or federal courts
            > located in the State of Delaware. All other Disputes shall
            > be arbitrated or litigated in small claims court. This
            > subsection does not prevent you or Company from
            > participating in a class-wide settlement of claims.

        d.  **Attorneys' Fees and Costs.** The parties shall bear their
            > own attorneys' fees and costs in arbitration unless the
            > arbitrator finds that either the substance of the Dispute
            ...
            > 11(b)). If you or Company need to invoke the authority of
            > a court of competent jurisdiction to compel arbitration,
            > then the party that obtains an order compelling
        ...
        e.  **Batch Arbitration.** To increase the efficiency of
            > administration and resolution of arbitrations, you and
            > Company agree that in the event that there are 100 or more
            > individual Requests of a substantially similar nature
            > filed against Company by or with the assistance of the
            > same law firm, group of law firms, or organizations,
            > within a 30 day period (or as soon as possible
            > thereafter), the JAMS shall (1) administer the arbitration
            > demands in batches of 100 Requests per batch (plus, to the
            > extent there are less than 100 Requests left over after
            > the batching described above, a final batch consisting of
            > the remaining Requests); (2) appoint one arbitrator for
            > each batch; and (3) provide for the resolution of each
            > batch as a single consolidated arbitration with one set of
...
Arbitrator**"). In an effort to expedite resolution of any such dispute
by the Administrative Arbitrator, the parties agree the Administrative
...
1.  1.  a.  **30-Day Right to Opt Out.**  You have the right to opt out
            > of the provisions of this Arbitration Agreement by sending
            > a timely written notice of your decision to opt out to the
            > following address: 2810 N Church St, PMB 85044,
            > Wilmington, DE 19802 US, Wilmington, Delaware 19802, or
            > email to contact@codelynx.dev, within 30 days after first
            > becoming subject to this Arbitration Agreement. Your
            > notice must include your name and address and a clear
            > statement that you want to opt out of this Arbitration
            > Agreement. If you opt out of this Arbitration Agreement,
            > all other parts of these Terms will continue to apply to
            > you. Opting out of this Arbitration Agreement has no
            > effect on any other arbitration agreements that you may
            > currently have with us, or may enter into in the future
            > with us.

        b.  **Invalidity, Expiration.** Except as provided in the
            > subsection entitled "Waiver of Class or Other
            > Non-Individualized Relief", if any part or parts of this
            > Arbitration Agreement are found under the law to be
            > invalid or unenforceable, then such specific part or parts
            > shall be of no force and effect and shall be severed and
            > the remainder of the Arbitration Agreement shall continue
            > in full force and effect. You further agree that any
            > Dispute that you have with Company as detailed in this
            > Arbitration Agreement must be initiated via arbitration
            > within the applicable statute of limitation for that claim
            > or controversy, or it will be forever time barred.
            > Likewise, you agree that all applicable statutes of
            > limitation will apply to such arbitration in the same
            > manner as those statutes of limitation would apply in the
        ...
        c.  **Modification** Notwithstanding any
            ...
            > Company makes any future material change to this
            > Arbitration Agreement, you may reject that change within
            > 30 days of such change becoming effective by writing
            > Company at the following address: 2810 N Church St, PMB
            > 85044, Wilmington, DE 19802 US, Wilmington, Delaware
            > 19802, or email to contact@codelynx.dev. Unless you reject
            > the change within 30 days of such change becoming
            > effective by writing to Company in accordance with the
            > foregoing, your continued use of the Site and/or Services,
            > including the acceptance of products and services offered
            > on the Site following the posting of changes to this
            > Arbitration Agreement constitutes your acceptance of any
            > such changes. Changes to this Arbitration Agreement do not
            > provide you with a new opportunity to opt out of the
            > Arbitration Agreement if you have previously agreed to a
            > version of these Terms and did not validly opt out of
            > arbitration. If you reject any change or update to this
            > Arbitration Agreement, and you were bound by an existing
            > agreement to arbitrate Disputes arising out of or relating
            > in any way to your access to or use of the Services or of
            > the Site, any communications you receive, any products
            > sold or distributed through the Site, the Services, or
            > these Terms, the provisions of this Arbitration Agreement
            > as of the date you first accepted these Terms (or accepted
            > any subsequent changes to these Terms) remain in full
            > force and effect. Company will continue to honor any valid
            > opt outs of the Arbitration Agreement that you made to a
            > prior version of these Terms. 

    2.  **Export.** The Site may be subject to U.S. export control laws
    ...
    3.  **Disclosures.** Company is located at the address in Section
        > 10.8. If you are a California resident, you may report
        > complaints to the Complaint Assistance Unit of the Division of
        > Consumer Product of the California Department of Consumer
        > Affairs by contacting them in writing at 400 R Street,
        > Sacramento, CA 95814, or by telephone at (800) 952-5210.

    4.  **Electronic Communications.** The communications between you
        > and Company use electronic means, whether you use the Site or
        > send us emails, or whether Company posts notices on the Site
    ...
    5.  **Entire Terms.** These Terms constitute the entire agreement
        > between you and us regarding the use of the Site. Our failure
    ...
    6.  **Copyright/Trademark Information**. Copyright ©
        > [2023 Codelynx, LLC. All rights reserved. All
...
>
> Telephone: (740) 990-2298
>
> Email: contact@codelynx.dev`
